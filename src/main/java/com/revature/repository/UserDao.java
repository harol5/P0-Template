...
//        newUser.setUsername("Harol"); // make sure the username is unique
//        newUser.setPassword("4347542");
//        System.out.println(dao.createUser(newUser));
////        System.out.println(dao.getUserByUsername("Laura"));
//    }
