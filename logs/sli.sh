httpCodes=$(grep Response rollingLogFile.2022-12-14.log | cut -f 1 -d ,| cut -f 2 -d : | cut -f 2 -d [ | cut -f 1 -d ] | cut -f 1 -d ' ')
...
echo "Execution success rate: $resultExecutionSuccess%"
